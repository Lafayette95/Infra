...
*   **v1 scope: futures only.** Absolute contracts and relative tickers (`.c.N`/`.v.N`) both supported; options settlement/OI is deferred (needs a persisted options contracts table first, which doesn't exist yet either).
